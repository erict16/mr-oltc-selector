...
export const CLI_HELP = `mr-oltc — OLTC type selection (package: mr-oltc-selector, no prices)

Usage:
  mr-oltc --iu 350 --um 72.5 --conn Y --reg W --pm 8
  mr-oltc --mva 25 --kv 110 --conn Y --reg W --pm 8
  mr-oltc --iu 500 --um 123 --conn Y --reg W --pm 8 --structure combined
