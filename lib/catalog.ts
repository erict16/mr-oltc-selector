...
export const SERIES: SeriesDef[] = [
  ...
  },
  {
    id: "vrm",
    code: "VRM",
    nameEn: "VACUTAP VRM combined in-tank vacuum OLTC",
    nameZh: "VRM 箱内真空有载",
    mounting: ["in_tank"],
    medium: "oil_vacuum",
    structure: "combined",
    ...
    defaultMdu: "",
    notesEn:
      "Same current axis as VRS. III is Y-only. Default min-adequate still picks VRS. Flyer IN5062036.",
    notesZh: "电流轴与 VRS 相同。三相只有星点。默认仍出 VRS。",
    rank: 61,
  },
  {
    id: "vrl",
  ...
  },
  {
    id: "vrh",
    code: "VRH",
    nameEn: "VACUTAP VRH high step-voltage in-tank vacuum OLTC",
    nameZh: "VRH 高极电压箱内真空有载",
    mounting: ["in_tank"],
    medium: "oil_vacuum",
    structure: "combined",
    vacuum: true,
    ...
    maxPositionsWithChangeOver: 35,
    defaultMdu: "",
    notesEn: "Ust 6000 V. III 650Y / 1300 Y. I 2622 forced current splitting. IN5062036.",
    notesZh: "级电压 6000 V。三相 650Y / 1300Y。",
    rank: 63,
  },
  {
    id: "vrx",
    code: "VRX",
    nameEn: "VACUTAP VRX I-only high step-voltage in-tank vacuum OLTC",
    nameZh: "VRX 单相高极电压箱内真空有载",
    mounting: ["in_tank"],
    medium: "oil_vacuum",
    structure: "combined",
    vacuum: true,
    currents: { I: [650, 1300] },
    currentTokens: { I: [652, 1302] },
    umKv: [72.5, 123, 170, 245, 300, 362, 420],
    usesSelectorSize: true,
    selectorSizes: ["B", "C", "D", "DE", "E"],
    maxStepVoltageV: 12000,
    stepCapacityByCurrent: { 650: 6000, 1300: 12000 },
    connections: ["Y", "D"],
    iiiConnections: [],
    maxPositionsLinear: 18,
    maxPositionsWithChangeOver: 35,
    defaultMdu: "",
    notesEn:
      "Flyer: VRX I 652 and I 1302 only. No II/III type. Ust 12000 V. IN5062036.",
    notesZh: "只有单相 I 652 / I 1302。没有三相型号。",
    rank: 64,
  },
  {
    id: "oiltap_v",
    ...
    structure: "compound",
    vacuum: false,
    currents: { I: [350], III: [200, 250, 350, 400] },
    umKv: [40, 76, 123],
    umKvY: [40, 76, 123],
    umKvD: [40, 76, 123],
    ...
    defaultMdu: "",
    notesEn:
      "Oil only. TD 82: V III 200/350 Y/D standard; V III 250/400 Y/D special, drawings on request. V I 350. I Um max 76. No III 500.",
    notesZh: "仅油灭弧。TD 82：V III 200/350 常规，250/400 特制图另出。无 III 500。",
    rank: 15,
  },
  {
    id: "oiltap_g",
