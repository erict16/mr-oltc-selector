...
const INSTALL = "npx -y mr-oltc-selector@1.0.3";
const RUN = "npx -y mr-oltc-selector@1.0.3 --iu 350 --um 72.5 --conn Y --reg W --pm 8";
        ...
        <li className="guide-step">
          ...
          <div className="guide-step-body">
            ...
            <p className="guide-alt">
              {c.s1alt}{" "}
              <a href={ZIP} download="oltc-selector-skill.zip">
                {c.dl}
              </a>{" "}
              ·{" "}
